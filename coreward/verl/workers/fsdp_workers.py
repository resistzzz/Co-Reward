...
class ActorRolloutRefWorker(Worker):
    ...
    def update_actor(self, data_ori: DataProto, data_aug: DataProto):
        ...
        data_ori = data_ori.to(torch.cuda.current_device())
        data_aug = data_aug.to(torch.cuda.current_device())
        # breakpoint()
        ...
        with self.ulysses_sharding_manager:
            data_ori = self.ulysses_sharding_manager.preprocess_data(data=data_ori)
            data_aug = self.ulysses_sharding_manager.preprocess_data(data=data_aug)
            # perform training
